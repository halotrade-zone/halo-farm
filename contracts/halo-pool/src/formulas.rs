...
pub fn update_pool(pool_info: &mut PoolInfo, staked_token_supply: Uint128, accrued_token_per_share:Uint128, current_time: u64, last_reward_time: u64) -> (Uint128, u64) {
